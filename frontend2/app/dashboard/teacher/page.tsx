...
const TeacherAssignmentsPage = () => {
  ...
  const fetchAssignments = async () => {
    try {
      const res = await fetch('http://localhost:5000/api/getAssignments');
  ...
  const handleDelete = async (id: string) => {
    ...
    try {
      await fetch(`http://localhost:5000/api/deleteassignment/${id}`, {
        method: 'DELETE',
      });
  ...
  const getStatusInfo = (assignment: AssignmentType) => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black text-gray-100 p-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {assignments.map((assignment) => {
          ...
          const percent = assignment.submissionCount > 0
              ...
              <div className="p-6 flex flex-col h-full">
                ...
                <div className="flex-grow">
                  ...
                  <div className="grid grid-cols-2 gap-2 mt-4">
                    <div className="bg-black/30 p-3 rounded-lg">
                      ...
                      <p className="text-lg font-bold text-white">{assignment.submissionCount || 0}</p>
                    </div>
                    <div className="bg-black/30 p-3 rounded-lg">
                      <p className="text-xs text-gray-400 mb-1">Graded</p>
                      <p className="text-lg font-bold text-green-400">{assignment.gradedCount || 0}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-6 flex justify-between items-center">
                  ...
                  <div className="flex ml-4">
                    <Edit size={18} className="text-gray-400 hover:text-white mr-2 cursor-pointer" />
                    <Trash2
                      size={18}
