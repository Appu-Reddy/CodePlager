...
import { Search, Clock, Award, Code, User, Percent } from 'lucide-react';
...
const TeacherDashboard = () => {
  ...
  const dummystud = [
    { id: 'S1001', name: 'Alex Johnson', percentage: 5, submittime: '2025-04-24T09:15:00', code: 'student-code-1' },
    { id: 'S1002', name: 'Maria Garcia', percentage: 8, submittime: '2025-04-24T08:30:00', code: 'student-code-2' },
    { id: 'S1003', name: 'Raj Patel', percentage: 2, submittime: '2025-04-24T10:05:00', code: 'student-code-3' },
    { id: 'S1004', name: 'Emma Wilson', percentage: 15, submittime: '2025-04-24T09:45:00', code: 'student-code-4' },
    { id: 'S1005', name: 'Liu Wei', percentage: 7, submittime: '2025-04-24T11:20:00', code: 'student-code-5' },
    { id: 'S1006', name: 'John Smith', percentage: 12, submittime: '2025-04-24T08:15:00', code: 'student-code-6' },
    { id: 'S1007', name: 'Sofia Rodriguez', percentage: 4, submittime: '2025-04-24T10:30:00', code: 'student-code-7' },
    { id: 'S1008', name: 'David Kim', percentage: 9, submittime: '2025-04-24T09:55:00', code: 'student-code-8' },
    { id: 'S1009', name: 'Aisha Ahmed', percentage: 3, submittime: '2025-04-24T10:45:00', code: 'student-code-9' },
    { id: 'S1010', name: 'Olivia Brown', percentage: 10, submittime: '2025-04-24T11:05:00', code: 'student-code-10' },
  ];

  const filteredStudents = dummystud
    .filter(student => {
  ...
  const leaderboardStudents = [...dummystud]
    .sort((a, b) => {
          ...
          <div className="bg-black rounded-xl p-6 shadow-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-black p-4 rounded-lg flex flex-col items-center justify-center">
                ...
                <span className="text-2xl font-bold">{dummystud.length}</span>
              ...
              <div className="bg-black p-4 rounded-lg flex flex-col items-center justify-center">
                ...
                <span className="text-2xl font-bold">{Math.round(dummystud.reduce((acc, student) => acc + student.percentage, 0) / dummystud.length)}%</span>
              ...
              <div className="bg-black p-4 rounded-lg flex flex-col items-center justify-center">
                ...
                <span className="text-2xl font-bold">{dummystud.filter(s => s.percentage < 5).length}</span>
