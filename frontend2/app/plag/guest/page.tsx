...
export default function GuestLanding() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 dark:bg-black text-gray-900 dark:text-white transition-all">
      <Head>
      ...
      <header className="absolute top-0 left-0 w-full p-4 border-b dark:border-gray-700 bg-white dark:bg-gray-950 shadow-md text-center">
      ...
      <main className="flex flex-col items-center justify-center px-6 py-20 space-y-10 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-6 mt-8">
          <button
            ...
            className="px-8 py-4 text-lg rounded-lg bg-blue-800 hover:bg-blue-900 transition duration-300 hover:scale-105 cursor-pointer  text-white shadow-md"
          >
          ...
          <button
            ...
            className="px-8 py-4 text-lg rounded-lg bg-green-800 hover:bg-green-900 transition duration-300 hover:scale-105 cursor-pointer text-white transition shadow-md"
          >
            Analyze Two Codes
          </button>
        </div>
